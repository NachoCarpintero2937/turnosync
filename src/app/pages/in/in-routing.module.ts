...
const routes: Routes = [
  ...
  },
  {
    path: 'clients',
    loadChildren: () =>
      import('../../pages/in/clients/clients.module').then(
        (m) => m.ClientsModule,
      ),
    canActivate: [PermissOnly],
    data: {
  ...
  },
  {
    path: 'services',
    loadChildren: () =>
      import('../../pages/in/services/services.module').then(
        (m) => m.ServicesModule,
      ),
    canActivate: [PermissOnly],
    data: {
  ...
  },
  {
    path: 'reports',
    loadChildren: () =>
      import('../../pages/in/reports/reports.module').then(
        (m) => m.ReportsModule,
      ),
    canActivate: [PermissOnly],
    data: {
  ...
  },
  {
    path: 'profile',
    loadChildren: () =>
      import('../../pages/in/profile/profile.module').then(
        (m) => m.ProfileModule,
      ),
    canActivate: [PermissOnly],
    data: {
  ...
  },
  {
    path: 'settings',
    loadChildren: () =>
      import('../../pages/in/settings/settings.module').then(
        (m) => m.SettingsModule,
      ),
    canActivate: [PermissOnly],
    data: {
  ...
  },
  {
    path: 'campaigns',
    loadChildren: () =>
      import('../../pages/in/campaings/campaings.module').then(
        (m) => m.CampaingsModule,
      ),
    canActivate: [PermissOnly],
    data: {
  ...
  },
  {
    path: 'caja',
    loadChildren: () =>
      import('../../pages/in/caja/caja.module').then((m) => m.CajaModule),
    canActivate: [PermissOnly],
    data: {
      permissions: {
        only: ['VIEW_CAJA'],
